...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Fastpy","description":"Production-ready FastAPI starter with FastCLI code generator","base":"/fastpy/","head":[],"router":{"prefetchLinks":true},"appearance":"dark","themeConfig":{"logo":"/logo.svg","siteTitle":"Fastpy","nav":[{"text":"Guide","link":"/guide/introduction"},{"text":"CLI Commands","link":"/commands/overview"},{"text":"API Reference","link":"/api/authentication"},{"text":"Examples","link":"/examples/blog"},{"text":"v1.0.0","items":[{"text":"Changelog","link":"https://github.com/vutia-ent/fastpy/releases"},{"text":"Contributing","link":"https://github.com/vutia-ent/fastpy/blob/main/CONTRIBUTING.md"}]}],"sidebar":{"/guide/":[{"text":"Getting Started","items":[{"text":"Introduction","link":"/guide/introduction"},{"text":"Installation","link":"/guide/installation"},{"text":"Quick Start","link":"/guide/quickstart"},{"text":"Configuration","link":"/guide/configuration"}]},{"text":"Architecture","items":[{"text":"Project Structure","link":"/architecture/structure"},{"text":"Patterns","link":"/architecture/patterns"},{"text":"Middleware","link":"/architecture/middleware"}]}],"/commands/":[{"text":"CLI Commands","items":[{"text":"Overview","link":"/commands/overview"},{"text":"Server Commands","link":"/commands/server"},{"text":"Database Commands","link":"/commands/database"},{"text":"Make Commands","link":"/commands/make"},{"text":"AI Integration","link":"/commands/ai"}]},{"text":"Field Types","items":[{"text":"Overview","link":"/fields/overview"},{"text":"Basic Types","link":"/fields/basic"},{"text":"Advanced Types","link":"/fields/advanced"},{"text":"Validation Rules","link":"/fields/validation"}]}],"/api/":[{"text":"API Reference","items":[{"text":"Authentication","link":"/api/authentication"},{"text":"Responses","link":"/api/responses"},{"text":"Exceptions","link":"/api/exceptions"},{"text":"Pagination","link":"/api/pagination"}]}],"/testing/":[{"text":"Testing","items":[{"text":"Setup","link":"/testing/setup"},{"text":"Fixtures","link":"/testing/fixtures"},{"text":"Factories","link":"/testing/factories"}]}],"/deployment/":[{"text":"Deployment","items":[{"text":"Production","link":"/deployment/production"},{"text":"Docker","link":"/deployment/docker"}]}],"/examples/":[{"text":"Examples","items":[{"text":"Blog System","link":"/examples/blog"},{"text":"E-commerce","link":"/examples/ecommerce"},{"text":"API Service","link":"/examples/api-service"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/vutia-ent/fastpy"},{"icon":"x","link":"https://twitter.com/vutia"}],"footer":{"message":"Released under the MIT License.","copyright":"Copyright © 2024-present Vutia"},"editLink":{"pattern":"https://github.com/vutia-ent/fastpy/edit/main/docs/:path","text":"Edit this page on GitHub"},"search":{"provider":"local"},"outline":{"level":[2,3]}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CEjNwk9O.js"));
